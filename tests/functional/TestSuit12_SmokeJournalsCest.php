...
class SmokeJournalsCest {
    ...
    public function JournalsModule(AcceptanceTester $I) {

        $this->perehod->open_object_and_module($I, 128, 'journals');

        foreach ($this->locator->locator_journals as $locator) {
